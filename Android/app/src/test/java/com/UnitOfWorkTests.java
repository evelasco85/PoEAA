...
import com.CustomerServices.CustomerInvocationDelegates;
...
import com.CustomerServices.CustomerUoWDelegate;
...
public class UnitOfWorkTests {
    ...
    public void TestCommit_SimpleInsertion()
    {
        ...
        assertEquals(true, sequenceDescription.contains("1=Insert=com.CustomerServices.Customer"));
        assertEquals(true, sequenceDescription.contains("3=Insert=com.CustomerServices.Customer"));
        assertEquals(true, sequenceDescription.contains("2=Insert=com.CustomerServices.Customer"));
    }
}
